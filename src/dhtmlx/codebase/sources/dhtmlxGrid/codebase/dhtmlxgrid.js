	...
	*/			
	...
	loadXMLString:function(str, afterCall){
		if (window.console && window.console.info)
		  window.console.info("loadXMLString was deprecated", "http://simple_demo.dhtmlx.com/migration__index.html#migrationfrom43to44");
	...
	loadXML:function(url, afterCall){
		if (window.console && window.console.info)
			window.console.info("loadXML was deprecated", "http://simple_demo.dhtmlx.com/migration__index.html#migrationfrom43to44");
