...
"dhx_textarea editable";this.obj.style.margin="0px 0px 0px 0px";this.obj.style.border="0px";this.obj=c}document.body.appendChild(this.obj);if(_isOpera)this.obj.onkeypress=function(a){if(a.keyCode==9)return!1};this.obj.onkeydown=function(a){var b=a||event;if(b.keyCode==9)return globalActiveDHTMLGridObject.entBox.focus(),globalActiveDHTMLGridObject.doKey({keyCode:b.keyCode,shiftKey:b.shiftKey,srcElement:"0"}),!1};this.obj.style.left=a[0]+"px";this.obj.style.top=a[1]+this.cell.offsetHeight+"px";var d=this.cell.offsetWidth<
...
/************* CUSTOM TXTNEW TO TAKE CARE OF '<' AND '\n' CHARACTERS BEGINS ****************/

/**
 *	@desc: custom multilene popup editor
 *	@returns: dhtmlxGrid cell editor object
 *	@type: public
*/
function eXcell_txtnew(cell){
	if (cell){
		this.cell=cell;
...
eXcell_txtnew.prototype=new eXcell;

eXcell_txtnew.prototype.setValue=function(val){
	this.cell._brval=val.replace(/&gt;/g,">").replace(/&lt;/g,"<").replace(/<br>/g,"\n");
